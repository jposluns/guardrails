...
**Version 0.1.5** (this file carries its own version, independent of the pack's SemVer release
...
leak-denylist check, an en/em dash check, an internal-link check, a site-integrity check, and roadmap, changelog, rules, and agents drift checks (generated files must match their sources). `tools/run_all_checks.sh`
