...
leak-denylist check, an en/em dash check, an internal-link check, a site-integrity check, and roadmap, changelog, rules, and agents drift checks (generated files must match their sources), and a rule-placement check. `tools/run_all_checks.sh`
