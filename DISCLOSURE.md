...
Claim: AIQT is open source under the Apache License 2.0: you may use, copy, modify, distribute, and prepare derivative works of it freely, including commercially, and you keep your changes. If you redistribute it you keep the licence, copyright, and NOTICE intact and state any significant changes you made, as the licence requires (Apache License 2.0, section 4).
