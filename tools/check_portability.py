...
BINARY_ALLOW = {"site/downloads/aiqt-skill.zip", "site/downloads/aiqt-skill-1.0.0.zip"}
...
def _build_surface(base, name, email):
    ...
    (base / "site/downloads/aiqt-skill-1.0.0.zip").write_bytes(b"PK\x03\x04 synthetic zip bytes, not text")
    return base
