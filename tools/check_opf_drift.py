...
def _git_toplevel(anchor):
    ...
    garbage `.git` gitfile yields git's own exit 128), or empty/malformed output all return None -- the caller
    maps that to a cannot-evaluate (exit 2), never a false pass."""
    import shutil
