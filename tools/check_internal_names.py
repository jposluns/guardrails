...
both verified clean of provenance shapes), plus the public hooks-preview/ channel, NOT the whole tree: the existing pack legitimately carries
...
SCOPE_RELPATHS = (
    ...
    "hooks-preview",             # the public hooks preview channel (skipped once retired)
)
