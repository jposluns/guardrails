...
description = "Where AIQT comes from: it began inside the GRC Library, a public documentation project written under an AI-managed workflow, and became a portable standard in its own right. Created and led by Jeff Posluns, open source under the Apache License 2.0."
canonical = "https://aiqt.ai/about"
og-title = "About AIQT: origin, direction, and the maintainer"
og-description = "Where AIQT comes from: it began inside the GRC Library, a public documentation project written under an AI-managed workflow, and became a portable standard in its own right. Created and led by Jeff Posluns, open source under the Apache License 2.0."
...
<section id="direction">
  <div class="wrap">
    ...
    <p>Open source, portable, and shared is the working answer. AIQT is open source
      under the Apache License 2.0, contributing an improvement back is Rule 5's voluntary
