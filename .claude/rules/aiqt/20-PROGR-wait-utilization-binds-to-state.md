...
facet: PROGR
secondary: [TRUST]
slug: wait-utilization-binds-to-state
---
...
intervening progress and no genuine human input is idling, however it is narrated, and a fired timer
never resets that state.
